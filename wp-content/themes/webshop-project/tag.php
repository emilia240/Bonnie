  ...
  <?php if (have_posts()) : ?>
    <ul class="space-y-8">
      <?php while (have_posts()) : the_post(); ?>
        <li class="bg-[#1C3361] text-[#F4F4F4] rounded-lg shadow lg:hover:shadow-lg transition-shadow duration-200 transition-transform duration-300 lg:hover:scale-105 !p-8">
